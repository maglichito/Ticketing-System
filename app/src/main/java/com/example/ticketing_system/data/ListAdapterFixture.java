...
public class ListAdapterFixture extends ArrayAdapter<Fixture> {
    ...
    public ListAdapterFixture(Context context, int resource, ArrayList<Fixture> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String stadium = getItem(position).getStadium();
        ...
        Fixture fixture = new Fixture(id,home,away,date,time,home_logo,away_logo,stadium);
